  ...
  <div id="app">
    <div class="container">
      ...
      <section class="homes">
        <div class="home">
          ...
          <svg class="home__like">
            <use xlink:href="img/sprite.svg#icon-heart-full" />
          </svg>
          ...
          <div class="home__area">
            <svg>
              <use xlink:href="img/sprite.svg#icon-expand" />
            </svg>
            <p>
              325 m
              <sup>2</sup>
      ...
      <footer class="footer">
        ...
        <p class="copyright">
          A website footer is found at the bottom of your site pages. It
          typically includes important information such as a copyright notice, a
          disclaimer, or a few links to relevant resources.
        </p>
      </footer>
    </div>
  </div>
